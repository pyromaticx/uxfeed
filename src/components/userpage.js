        ...
        return (
            <div style={pageWrapper}>
                ...
                <div style={annotationWrapper}>
                  ...
                  {this.props.route.path == 'collections/:collectionId' ? (<div style={{width: '100%', paddingLeft: '25%', paddingRight: '25%', textAlign: 'center', backgroundColor: '#fff', marginBottom: '20px'}}><p>Share this collection on:</p><SocialOptions collection={this.state.collectionData}/></div>) : ''}
